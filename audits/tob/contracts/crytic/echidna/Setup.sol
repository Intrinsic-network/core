...
import '../../../../../contracts/IntrinsicFactory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the intrinsic factory will do when you create the pool
...
contract SetupIntrinsic {
    IntrinsicPool public pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    IntrinsicFactory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new IntrinsicFactory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = IntrinsicPool(factory.createPool(address(token0), address(token1), _fee));
        pool.initialize(_startPrice);
    }
}

contract IntrinsicMinter {
    IntrinsicPool pool;
    TestERC20 token0;
    TestERC20 token1;
    ...
    function setPool(IntrinsicPool _pool) public {
        pool = _pool;
    }
