...
describe('IntrinsicPool', () => {
  ...
  let pool0: MockTimeIntrinsicPool
  let pool1: MockTimeIntrinsicPool
  ...
  let swapTargetCallee: TestIntrinsicCallee
  let swapTargetRouter: TestIntrinsicRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeIntrinsicPool, any]> => {
