...
describe('IntrinsicFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as IntrinsicFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('IntrinsicPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('IntrinsicPool')
